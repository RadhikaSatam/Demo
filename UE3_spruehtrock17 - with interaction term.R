...
#preparation
dimdoe_path<-"C:\\Users\\Radhika\\Desktop\\HIS SEM 3\\HIS project\\Spray_drying\\"
script_path<-paste(dimdoe_path,"R-sequences\\",sep="")
ex_path<-"C:\\Users\\Radhika\\Desktop\\HIS SEM 3\\HIS project\\Spray_drying\\examples\\UE3_spruehtrock17\\"
...
Dfrml<-as.list(DLdesign$Dfrml);Dfrml
Dfrml<-paste(DLdesign$Dfrml,"I(QVh*PI2)",sep="+");Dfrml # added for testing from line 103-107
Dfrml<-paste(DLdesign$Dfrml,"I(PI2*PI3)",sep="+");Dfrml
Dfrml<-paste(DLdesign$Dfrml,"I(PI3*PI5)",sep="+");Dfrml
Dfrml<-paste(DLdesign$Dfrml,"I(PI2*QVh)",sep="+");Dfrml
terms<-(transDimDoeMod(as.character(Dfrml),x_roles,forward = FALSE));terms
